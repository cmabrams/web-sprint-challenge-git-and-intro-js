...
function getArtistByIndex(insertArray,insertIndex) {
  const artistIndexString = `the artist at index ${insertArray[insertIndex].id} is ${insertArray[insertIndex].name}`;
  return artistIndexString;
}
...
function listOfNames(insertArray) {
  let justTheNames = insertArray;
  for(let i=0; i<justTheNames.length;i++){
    justTheNames[i] = justTheNames[i].name;
  }
  return justTheNames;
}
...
function removeArtist(insertArray,insertIndex) {
  let removeAnyArtist = insertArray;
  removeAnyArtist.splice(insertIndex,1);
  return removeAnyArtist;
}
...
function addArtist(insertArray,insertName,insertYear,insertGenre,insertNationality,insertBio) {
  let addAnyArtist = insertArray;
  addAnyArtist.push({name: insertName, years: insertYear, genre: insertGenre, nationality: insertNationality, bio: insertBio});
  return addAnyArtist;
}
...
function lotsOfArt(insertArray) {
  let bigArtistNames = [];
  for(let i=0;i<insertArray.length;i++){
    let NumberOfPaintings = insertArray[i].paintings
    if(NumberOfPaintings>100){
    bigArtistNames.push(insertArray[i].name);
    }
  }
  return bigArtistNames;
}
...
function artistInfo(insertArray,artistName){
  let artistBio = '';
  for(let i=0;i<insertArray.length;i++){
    if(artistName === insertArray[i].name){
    artistBio = insertArray[i].bio;
  }
  }
  return artistBio;
}
...
function artistByCountry(insertArray,insertNationality){
  let ofSameNationality = [];
  for(let i=0;i<insertArray.length;i++){
    if(insertArray[i].nationality === insertNationality){
      ofSameNationality.push(insertArray[i].name);
    }
  }
  return ofSameNationality;
}
